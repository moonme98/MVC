...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////--> 
 <form name="loginForm"  method="post" action="/user/login" target="_parent" onsubmit="return fncLogin();">
                       ...
                       <tr> 
                         <td width="56">
						    <input type="submit" value="" 
						           style="width:56px; height:20px; background:url('/images/btn_login.gif') no-repeat; border:none; cursor:pointer;" />
						</td>
                         <td width="10">&nbsp;</td>
                         <td width="70">
                         	<!-- ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
