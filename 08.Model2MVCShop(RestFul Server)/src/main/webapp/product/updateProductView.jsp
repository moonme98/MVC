...
<form name="detailForm" method="post" enctype="multipart/form-data" action="/product/updateProduct">
		...
		<td class="ct_write01">
			<c:if test="${not empty product.fileName}">
		        <img src="/images/uploadFiles/${product.fileName}" 
		             alt="상품 이미지" 
		             style="max-width:200px; height:auto; margin-bottom:5px;"/>
		    </c:if>
    
			<input type="file" name="uploadFiles" class="ct_input_g" 
   				 style="width: 200px; height: 30px" maxLength="13" value="${product.fileName}"/>
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
