...
<head>
	...
	<script type="text/javascript">
		...
		function fncUpdatePurchase(){
			...
			$("form").attr("method" , "POST").attr("enctype" , "multipart/form-data").attr("action" , "/purchase/updatePurchase?tranNo=" + tranNo).submit();
		}
...
<table width="600" border="0" cellspacing="0" cellpadding="0" align="center" style="margin-top: 13px;">
	...
	<tr>
		...
		<td class="ct_write01">
			<select name="paymentOption" class="ct_input_g" style="width: 100px; height: 19px">
				<option value="1" <c:if test="${purchase.paymentOption == '1'}">selected</c:if>>현금구매</option>
				<option value="2" <c:if test="${purchase.paymentOption == '2'}">selected</c:if>>신용구매</option>
			</select>
		</td>
	</tr>
	<tr><td height="1" colspan="3" bgcolor="D6D6D6"></td></tr>
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input type="text" id="addr" name="divyAddr" class="ct_input_g" 
