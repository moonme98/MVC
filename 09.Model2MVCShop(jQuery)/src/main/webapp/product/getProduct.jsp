...
<head>
	...
	<script type="text/javascript">
		...
		//==> 추가된부분 : "목록으로 가기" "바로 구매하기"  Event 연결 및 처리
		$(function() {
			...
			$( ".ct_btn01:contains('바로 구매하기')" ).on("click" , function() {
				//Debug..
				//alert(  $( "td.ct_btn01:contains('바로 구매하기')" ).html() );
	  ...
	  <div class="md:w-1/2 flex flex-col gap-4">
	   ...
	   <div class="mt-6">
	    ...
	    <div class="flex gap-3 mt-4">
	      <button class="ct_btn01 flex-1 border border-gray-900 text-gray-900 font-semibold py-2 rounded hover:bg-gray-100 transition"
	      		  onclick="location.href='/product/listProduct?menu=${sessionScope.menu}'">
	        목록으로 가기
	      </button>
	      <button class="ct_btn01 flex-1 bg-black text-white font-semibold py-2 rounded hover:bg-gray-800 transition">
	        바로 구매하기
	      </button>
	    </div>
	  </div>
